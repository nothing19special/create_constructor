...
async def login(page):
    ...
    await page.goto('https://admin.business.stage01.russpass.dev/')

    await page.get_by_placeholder('Введите эл. почту').fill('6vqdc@ptct.net')
    await page.get_by_placeholder('Введите пароль').fill('6vqdc@ptct.net1')
...
# 2. Функция создания конструктора
async def create_service(page):
    #Переход в конструктор
    await page.goto(f'https://admin.business.stage01.russpass.dev/events-control/{event_id}')
